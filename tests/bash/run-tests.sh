...
run_self_update_force_mock_test() {
    ...
    cp "$REPO_DIR/launchers/a11yctl.ps1" "$sandbox/a11yctl.ps1"
    cp "$REPO_DIR/launchers/a11yctl.cmd" "$sandbox/a11yctl.cmd"
    cp "$REPO_DIR/launchers/ea11ctl.ps1" "$sandbox/ea11ctl.ps1"
    cp "$REPO_DIR/launchers/ea11ctl.cmd" "$sandbox/ea11ctl.cmd"
